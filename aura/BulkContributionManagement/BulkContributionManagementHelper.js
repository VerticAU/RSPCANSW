({
    save: function (cmp, event, helper) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            console.log('request.batchId: ' + request.batchId);
            console.log('save BulkContributionManagementSaveRecProc.  Request: ', JSON.stringify(request));

            helper.execute(
                cmp,
                'BulkContributionManagementSaveRecProc',
                request,
                function (response) {
